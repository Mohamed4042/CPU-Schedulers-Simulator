...
public class AddProcess extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        try {
            // Provide a default color (you can modify this to a dynamic color if needed)
            String defaultColor = "defaultColor"; // Set the default color
            Process tmp = new Process(Name.getText(), defaultColor,
                    Integer.parseInt(arrivalTime.getText()),
                    Integer.parseInt(burstTime.getText()),
                    Integer.parseInt(priorityNumber.getText()),
